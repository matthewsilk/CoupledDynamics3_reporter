...
nreporter<-function(statuses,t2=t,pop_size,comms,type=c("C","NC","H","HC","D"),level=c("comm","pop"),mPps=0.2,Ps=0.5,Ph=1,Pr=1,Pd=1,Precd=1,delay=1,hosp_cap=20,eff=0.05,tp=tp,tn=tn,td=td,trd=trd){
