...
name=paste0("exp_",ind) #name of the simulation (should be unique)

outputname=file.path(folder_res,paste0(name,".RDS")) #file where result of the simulation will be sotred
